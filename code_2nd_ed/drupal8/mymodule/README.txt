...
1. On the Personal Data Form page at example.com/mymodule/my_form_page :
   a. The field labeled "Autocomplete field" should have auto-complete behavior.
   ...
   b. If you type in the field labeled "Type here to trigger Ajax", you should
      see a message saying "You have triggered Ajax", and just below that, a
      line saying "You typed [whatever you typed]".
   c. If you click the button that says "Click here to trigger Ajax", you
